...
$.payment.fn.formatCardDateOfBirth = ->
  @on('keypress', restrictNumeric)
  @on('keypress', restrictDateOfBirth)
  @on('keypress', formatDateOfBirth)
  @on('keypress', formatForwardSlashAndSpace)
  @on('keypress', formatForwardDateOfBirth)
  @on('keydown',  formatBackDateOfBirth)
  @on('change', reFormatDateOfBirth)
  @on('input', reFormatDateOfBirth)
  this
